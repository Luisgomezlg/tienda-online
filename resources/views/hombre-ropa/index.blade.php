...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Legado - Ropa hombre</title>
...
<h1 class="text-center">HOMBRE ROPA</h1>
  </div>
       ...
       <div class="row">
         ...
         <div class="col-sm-9 hidden-xs">
                      ...
                      <button type="button"  id="findBtn" class="btn btn-primary rounded-0" name="button">Filtrar estilo</button>
                       ...
                       <div class="col-sm-4 pull-right">
                        <div class="main d-flex justify-content-center">
                      <button type="button"  id="findBtn2" class="btn btn-primary rounded-0" name="button">Borrar estilo</button>
                    </div>
           						</div>
           					</div>
           				</div>
